...
class Python3NaoExample:
	def __init__(self):
		...
		# videoClient = self.s.ALVideoDevice.subscribe("python_client", resolution, colorSpace, 5)
		# naoImage = self.s.ALVideoDevice.getImageRemote(videoClient)

		# video_service = self.s.ALVideoDevice
		# import IPython; IPython.embed()
		# while True:
			# img = cv2.imread('../imageBottom.png')
			# print(detectball(img))

		# self.s.ALMotion.post.moveTo(0.3, 0.0, 0.0)
		
		# from inspect import signature
		# print(signature( self.s.ALMotion.post))
		# legName = ["LLeg", "RLeg"]
		# X       = 0.3
		# Y       = 0.0
		# Theta   = 0.0
		...
		# clearExisting = False
		# self.s.ALMotion.setFootStepsWithSpeed(legName, footSteps, fractionMaxSpeed, clearExisting)
		
		# self.s.ALMotion.waitUntilMoveIsFinished()
		# print('done')
